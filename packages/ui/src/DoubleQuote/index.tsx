...
export const DoubleQuoteVariants = cva(`relative flex items-center justify-center`, {
  variants: {
    size: {
...
export const DoubleQuote = ({ size, className, direction }: IDoubleQuoteProps) => {
  return (
    <div className={cn(DoubleQuoteVariants({ size }), className)}>
      <img
        src={direction === "up" ? "images/common/blue-up-quote.png" : "images/common/blue-down-quote.png"}
        alt="쌍따옴표"
