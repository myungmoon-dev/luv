...
const AboutCoreLabel = ({ type }: IAboutCoreLabelProps) => {
  ...
  return (
    ...
    >
      <p className="text-lg font-SCoreDream sm:text-4xl md:text-4xl lg:text-5xl md:font-medium">명문교회 2024 핵심가치와 비전</p>
      <div className="flex w-full justify-center gap-3 md:gap-7">
        <p className="font-SCoreDream text-2xl md:text-5xl lg:text-7xl">{labelTitle}</p>
