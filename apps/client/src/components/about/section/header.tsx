...
const AboutHeaderSection = ({ text1, text2, text3 }: IAboutHeaderSectionProps) => {
  return (
    <div data-aos="fade-up" className="flex flex-col items-center justify-start gap-3 md:gap-7">
      ...
      <p className="font-SCoreDream text-2xl text-blue-500 md:text-4xl lg:text-6xl">{text1}</p>
      <p className="font-SCoreDream text-2xl text-blue-500 md:text-4xl lg:text-6xl">{text2}</p>
