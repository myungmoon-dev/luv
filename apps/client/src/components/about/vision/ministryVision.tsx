...
const AboutMinistryVision = () => {
  return (
    <div className="flex flex-col py-7">
      <p className="mb-5 text-center text-lg font-medium text-[#222222] sm:text-2xl sm:font-bold">名門(명문)의 의미</p>
      <div className="mb-16 flex gap-4 overflow-x-scroll px-5 sm:mb-24 sm:px-7">
      ...
      <div className="mb-10 flex flex-col gap-4 px-5 sm:mb-24 sm:gap-8 sm:px-7">
        <PromiseCard>
          <p className="text-[17px] font-medium text-[#222222] sm:text-xl">
            양을 위하여 목숨을 버리는
            <br />
            목자의 심정으로 목회하겠습니다.
          </p>
          <p className="text-[15px] text-[#4F4F4F] sm:text-[17px]">
            영혼을 구원하기 위해 성육신하신
            <br />
            예수님의 마음을 본받아,
            <br />
