    ...
    <Section title="오시는 길">
      <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 sm:gap-3">
        <div className="flex flex-col items-center gap-5">
          <Chip color="blue" className="duration-500" text="독산동 비전채플(평일)" size="sm" selected={true} />
        ...
        <div className="flex flex-col items-center gap-5">
          <Chip color="blue" className="duration-500" text="서울여상 사랑채플(주일)" size="sm" selected={true} />
          <p className="h-7 text-center text-sm text-gray-500 md:h-10 lg:text-base">
            서울특별시 관악구 관악로 85
            <br />
