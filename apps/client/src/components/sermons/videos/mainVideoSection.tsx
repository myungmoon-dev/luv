...
const MainVideoSection = ({ video, title }: IMainVdieoSectionProps) => {
  return (
    <div className="w-full bg-white">
      <YoutubeVideo videoId={video.url} className="aspect-video w-full sm:w-[400px] md:w-full lg:h-[500px]" />
      <div className="px-5 pb-3 pt-4 sm:px-6 sm:pb-4 sm:pt-5 md:px-6 md:pb-5 md:pt-5 lg:px-8 lg:pb-6 lg:pt-6">
        <p className="mb-1 text-xs font-medium text-[#001F54] sm:mb-2 sm:text-sm md:text-base lg:text-lg">{title}</p>
