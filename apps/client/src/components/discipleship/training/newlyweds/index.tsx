  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 md:px-8">
      ...
      <div className="mb-6 sm:mb-8">
        <h2 className="mb-3 break-keep text-xl font-bold text-gray-900 sm:mb-4 sm:text-2xl">
          명문교회 신혼가정
        </h2>
        <div className="flex flex-col gap-1.5 break-keep text-sm text-gray-700 sm:gap-2 sm:text-base">
      ...
      {/* 모임 정보 */}
      <div className="mb-6 flex flex-col gap-1.5 break-keep text-xs text-gray-700 sm:mb-8 sm:gap-2 sm:text-sm md:text-base">
        <p>
      ...
      {/* 교육과정 */}
      <div className="mb-6 sm:mb-8">
        <h3 className="mb-3 break-keep border-b-2 border-gray-200 pb-2 text-lg font-bold text-gray-900 sm:mb-4 sm:text-xl">
          교육과정
        </h3>
        ...
        <div className="mb-4 flex gap-3 sm:mb-6 sm:gap-4">
          ...
          <div className="flex flex-col gap-1.5 sm:gap-2">
            <h4 className="break-keep text-base font-semibold text-gray-900 sm:text-lg">3 - 6월</h4>
            <div className="flex flex-col gap-0.5 break-keep text-xs text-gray-700 sm:gap-1 sm:text-sm">
        ...
        <div className="flex gap-3 sm:gap-4">
          ...
          />
          <div className="flex flex-col gap-1.5 sm:gap-2">
            <h4 className="break-keep text-base font-semibold text-gray-900 sm:text-lg">9 - 11월</h4>
            <div className="flex flex-col gap-0.5 break-keep text-xs text-gray-700 sm:gap-1 sm:text-sm">
              <p>큐티세미나 / 소그룹모임(QT)</p>
