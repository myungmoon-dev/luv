...
import ForNewCommersGuide from "./oldContents/guide";
import ForNewCommersDate from "./oldContents/date";
import ForNewCommersProcess from "./oldContents/process";
import ForNewCommersApply from "./oldContents/apply";
...
const DiscipleshipNew = () => {
  ...
  return (
    <div className="mb-20 flex w-full flex-col items-center justify-center gap-10 overflow-x-hidden">
      ...
      >
        <div className="2xl:gap-5 2xl:pb-14 absolute flex h-full w-full flex-col items-center justify-end gap-1 pb-10 lg:gap-3">
          <p
            data-aos="fade-up"
            className="2xl: 2xl:text-5xl break-keep text-center font-SCoreDream text-xl text-white lg:text-3xl"
          >
            은혜를 사모하여 찾아오신 여러분께
          </p>
          <div
            data-aos="fade-up"
            className="2xl:text-3xl flex flex-col text-center font-semibold leading-tight text-white lg:text-xl"
          >
