...
const EducationValueCard = ({
  ...
  return (
    <div className={cn("flex h-[200px] w-full flex-col items-center justify-around md:h-[400px]", className, bgColor, borderColor)}>
      ...
      <p
        data-aos="fade-up"
        className={cn("px-5 text-center text-sm font-semibold md:text-xl lg:text-2xl xl:text-3xl break-keep", textColor)}
      >
        {text}
      </p>
    </div>
