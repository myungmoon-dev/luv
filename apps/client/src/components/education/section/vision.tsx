...
const EducationVisionSection = () => {
  return (
    <div className="flex w-full flex-col gap-20">
      <CustomImage className="h-[600px]" src="/images/education/vision1.jpg" alt="비전 이미지" imgClass="brightness-50">
        <div className="absolute flex h-full w-full flex-col items-center justify-center gap-10">
          <EducationSectionTitle
            first="비전"
            second="Vision"
            className="flex items-center justify-center gap-3 text-8xl text-white"
          />
          <div data-aos="fade-up" className="flex flex-col items-center justify-center gap-4 text-5xl text-white">
            <p>하나님을 영화롭게 하며</p>
      ...
      <div className="grid grid-cols-3 gap-5" data-aos="fade-right">
        <EducationSectionText
          className="w-full flex-col justify-center gap-2 px-20 text-2xl font-medium"
          first="교회와 가정이 합력하여"
          second="분명한 복음과 말씀으로"
          third="다음세대를 세우는"
          pointText="교육 공동체"
      ...
      <div className="grid grid-cols-3 gap-5" data-aos="fade-left">
        ...
        />
        <EducationSectionText
          className="w-full flex-col justify-center gap-2 px-12 text-2xl font-medium"
          first="교사와 부모가"
