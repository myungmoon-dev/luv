...
const EducationMissionSection = () => {
  return (
    <div className="flex w-full flex-col items-center justify-center gap-1 sm:h-[300px] sm:gap-3">
      ...
      />
      <p data-aos="fade-up" className="font-bold text-gray-800 md:text-4xl lg:text-5xl">
        명문교회 교육부서는
      </p>
      <div data-aos="fade-up" className="flex font-bold text-gray-800 md:text-4xl lg:text-5xl">
        <p>하나님을 경외하는</p>
