...
const EducationOldCoreValuesSection = () => {
  return (
    <div className="flex w-full flex-col">
      <EducationSectionTitle
        className="xl:text-6xl flex w-full gap-1 p-5 text-2xl text-blue-500 md:p-10 md:text-4xl lg:text-5xl"
        first="핵심가치"
        second="Core Values"
      />
...
export default EducationOldCoreValuesSection;
