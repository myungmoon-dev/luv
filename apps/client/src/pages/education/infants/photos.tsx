...
export async function getStaticProps() {
  const imagePath = path.resolve("public/images/next-g.jpeg");
...
interface IEducationInfantsPhotosPageProps {
...
const EducationInfantsPhotosPage = ({ bannerBlurDataURL }: IEducationInfantsPhotosPageProps) => {
