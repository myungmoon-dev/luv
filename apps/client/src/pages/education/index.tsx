...
const EducationMenuTitle = () => {
  return (
    <div className="flex w-full items-center justify-between">
      <p className="text-[20px] font-bold text-[#222222] sm:text-[24px] md:text-[28px] lg:text-[32px]">다음세대</p>
      ...
      >
        ...
        <Icon name="CaretRight" sizeNumber={14} cursor="ui-cursor-pointer" className="sm:h-4 sm:w-4 md:h-5 md:w-5" />
      </button>
    </div>
  );
};
