    ...
    >
      <div className="flex flex-col gap-10">
        <div className="flex flex-col gap-5">
          <h3 className="text-3xl font-bold">명문교회</h3>
          <p>
            名門(명문)교회는 대한예수교장로회(합동)에 속한 교회로써 ‘이름을 얻는다’라는 의미로 이 문을들어오는 자마다
            어린양의 생명책에 이름이기록되며, 아브람이 아브라함으로, 야곱이 이스라엘로 새 이름을 얻어서 새로운 삶을
            얻는교회라는의미를 가지고 있습니다
          </p>
        </div>
        <div className="flex flex-col gap-5">
          <h3 className="text-3xl font-bold">목회비전</h3>
          <p>
        ...
        <div className="flex flex-col gap-5">
          <h3 className="text-3xl font-bold">로고의 의미</h3>
          <p>
