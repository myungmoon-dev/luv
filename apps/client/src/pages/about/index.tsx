    ...
    >
      <div className="flex flex-col gap-5 sm:text-lg md:text-xl">
        <div className="flex items-center justify-center gap-2 sm:gap-3 md:gap-5">
          ...
          <h2 className="mb-5 break-words text-center text-lg font-bold text-[#c8b3b3] sm:text-2xl md:text-3xl">
        ...
        <div className="justify-start font-bold sm:text-2xl">
