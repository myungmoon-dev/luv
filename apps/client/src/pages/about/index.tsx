  ...
  return (
    ...
    >
      <div className="flex flex-col gap-5">
        <h2 className="mb-5 text-3xl font-bold text-green-500">
          "명문교회 홈페이지를 방문해 주신 여러분을 주님의 이름으로 환영하고 축복합니다."
        </h2>
        <div>
          복음으로! 오직 성령의 능력으로! 회복을 넘어 부흥으로! 명문교회는 '지역과 민족을 품고 세계와 열방을 향해'
          나아가는 "생명의 공동체"입니다.
        </div>
        <div>
        ...
        <div className="mb-5">
          1) 양을 위하여 목숨을 버리는 목자의 심정으로 목회하겠습니다. 영혼을 구원하기 위해 성육신하신 예수님의 마음을
          본받아, 명문교회 모든 성도님들을 위한 한 알의 밀알이 되어 일사각오로 성도님들을 사랑하며 섬기겠습니다.
          <br />
          2) 생명을 걸고 설교 준비를 하고, 삶으로 설교하겠습니다. 명문의 강단이 푸른 감람나무 같고 물댄 동산 같아서 매
          주일 생명의 말씀이 선포되도록 하겠습니다. 설교자의 삶과 인격이 설교를 통해 흘러 갈 수 있도록 겸손하게 은혜를
          구하며 말씀을 전하겠습니다.
          <br />
          3) 기도하기를 쉬는 죄를 범하지 않고, 눈물과 무릎으로 목회하겠습니다. 사람의 능력이 아니라, 하나님의 능력으로
          목회하겠습니다. 무릎으로 교회를 세우고, 성도님들을 위해 간절한 눈물로 기도하겠습니다.
        </div>
        <div>
          ...
          사랑의교회에서 사역했으며, 현재 총신대 목회신학전문대학원에서 설교학 교수로도 섬기고 있습니다. 가족으로는 아내
          정지영과 두 아들 성재, 은재가 있습니다.
        </div>
