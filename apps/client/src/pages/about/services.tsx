...
const AboutServicesPage = () => {
  ...
  return (
    <Layout pageTitle="예배 정보" title="예배 정보" customBanner={<></>} hasChildrenPadding={false}>
      <LgNavigation />
      <div className="flex flex-col items-center justify-center gap-20 px-5 py-10 lg:pt-36 lg:w-[680px] lg:px-0 lg:mx-auto">
      ...
      <div className="mb-20 px-5">
        ...
        <div className="flex flex-col gap-3 lg:w-[900px] lg:px-0 lg:mx-auto">
          <KakaoMap address="서울특별시 관악구 관악로 85" height=" h-[230px] sm:h-[314px] md:h-[395px] lg:h-[508px]" />
          <div className="flex flex-col justify-center gap-2">
      ...
      <div className="mb-60 flex flex-col gap-4 px-5 lg:w-[680px] lg:px-0 lg:mx-auto">
