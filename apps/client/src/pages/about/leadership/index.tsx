      ...
      <Tabs menus={aboutLeaderMenus}>
        <div className="mb-14">
          <div className="mb-14 flex flex-col items-center gap-4 sm:gap-6 md:gap-8">
            ...
            />
            <div className="flex w-full flex-col px-5 py-4 sm:px-12 sm:py-6 md:px-16 md:py-8 lg:px-0">
              <p className="mb-5 text-xl font-bold text-[#001F54] md:text-2xl lg:px-10">인사말</p>
              <hr className="mb-4 border-[#747474] md:mb-10" />
              <p className="mb-4 px-2 text-[#6E6E6E] md:mb-10 md:text-xl lg:px-14">
            ...
            <p className="text-center font-medium text-[#464646] sm:text-xl md:text-2xl">
              김지혁 담임목사
            </p>
