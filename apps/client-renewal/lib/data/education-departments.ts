...
export const educationSlugToType: Record<string, EducationDeptType> = {
  infants: "infants",
  toddlers: "toddlers",
...
export const educationDepartmentList: EducationDepartmentData[] = [
  {
    ...
    slug: "infants",
    department: "영아부",
    heroImage: "/images/education/infants/1.jpg",
    ...
    coreministry: [
      {
        ...
        titleKr: "말씀",
        img: "/images/education/infants/coreMinistry/1.jpg",
        imgClass: "brightness-75 object-[0%_40%]",
      },
      {
        id: 2,
        ...
        imgClass: "brightness-75 object-[90%_40%]",
      },
      {
        id: 3,
        description: "심방, 구제헌금으로 이웃 사랑 실천하기",
        titleKr: "섬김",
        img: "/images/education/infants/coreMinistry/3.jpg",
  ...
  },
  {
    ...
    slug: "toddlers",
    department: "유치부",
    heroImage: "/images/education/toddlers/banner.jpg",
    heroImgClass: "object-[50%_70%]",
    imgs: [
    ...
    coreministry: [
      {
        ...
        titleKr: "복음 제시",
        img: "/images/education/toddlers/3.jpg",
        imgClass: "brightness-75 object-[50%_40%]",
      },
      {
        id: 2,
        description: "찬양, 설교, 공과, 암송, 특별 활동의 메시지 일원화",
        titleKr: "One Point 예배",
        img: "/images/education/toddlers/1.jpg",
        imgClass: "brightness-75 object-[50%_40%]",
      },
      {
        id: 3,
        ...
        imgClass: "brightness-75 object-[50%_80%]",
      },
      {
        id: 4,
        ...
        imgClass: "brightness-75 object-[0%_70%]",
      },
      {
        id: 5,
        description:
        ...
        titleKr: "전도 훈련",
        img: "/images/education/toddlers/banner.jpg",
        imgClass: "brightness-75 object-[100%_70%]",
      },
    ],
  },
  {
    ...
    slug: "elementary",
    department: "유초등부",
    heroImage: "/images/education/banner.jpg",
    heroImgClass: "object-[center_35%]",
    imgs: [
    ...
    coreministry: [
      ...
      },
      {
        ...
        imgClass: "brightness-75 object-[20%_70%]",
      },
      {
        id: 4,
        description:
  ...
  },
  {
    ...
    slug: "high",
    department: "중고등부",
    heroImage: "/images/education/high/banner.jpeg",
    heroImgClass: "object-[center_45%]",
    imgs: [
    ...
    coreministry: [
      {
        ...
        img: "/images/education/high/1.jpg",
        imgClass: "brightness-75 object-[0%_40%]",
      },
      {
        id: 2,
        ...
        titleKr: "Bible Camp",
        img: "/images/education/high/banner.jpeg",
        imgClass: "brightness-75 object-[50%_40%]",
      },
      {
        id: 3,
        ...
        titleKr: "Contact",
        img: "/images/education/high/3.jpg",
        imgClass: "brightness-75 object-[100%_40%]",
      },
      {
        id: 4,
        ...
        titleKr: "Disciple",
        img: "/images/education/high/2.jpg",
        imgClass: "brightness-75 object-[50%_40%]",
      },
    ],
  },
    ...
    coreministry: [
      {
        ...
        titleKr: "말씀 공동체",
        img: "/images/education/2youth/1.jpg",
        imgClass: "brightness-75 object-[0%_40%]",
      },
      {
        id: 2,
      ...
      },
      {
        ...
        titleKr: "섬김 공동체",
        img: "/images/education/2youth/coreMinistry/3.jpg",
        imgClass: "brightness-75 object-[100%_40%]",
      },
    ],
  },
...
const byType = Object.fromEntries(
  educationDepartmentList.map((d) => [d.type, d]),
) as Record<EducationDeptType, EducationDepartmentData>;

export function getEducationDepartment(type: EducationDeptType): EducationDepartmentData {
  return byType[type];
}

export function getEducationBySlug(slug: string): EducationDepartmentData | undefined {
  const t = educationSlugToType[slug];
  return t ? byType[t] : undefined;
}

/** 조사 은/는 */
export function departmentParticle(department: string): string {
