...
import { BookOpen, ClipboardList, FileText, FolderOpen, Globe } from "lucide-react";
...
const sections = [
  ...
  //   href: "/news/boards",
  //   title: "게시판",
  //   description: "교회의 공지·소식과 청빙 게시글을 확인하실 수 있습니다.",
  //   Icon: ClipboardList,
  // },
  {
    href: "/news/boards?type=invitation",
    title: "청빙게시판",
    description: "청빙 게시글을 확인하실 수 있습니다.",
    Icon: ClipboardList,
  },
  {
    href: "/news/bulletins",
    ...
    <>
      ...
      <div className="mx-auto max-w-6xl px-4 pb-16 sm:px-6 md:pb-20 lg:px-8">
        <header className="mb-10 text-center sm:mb-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-[#1e2a4a] sm:text-4xl">
            명문 소식
          </h1>
